...
POSIX standard is to always end with a newline.
...
#+begin_src emacs-lisp
  ...
  (bw/leader-key-def
    "fn" '((lambda () (interactive) (consult-find "~/Notes/")) :which-key "notes")
    ...
    "fdM" '((lambda () (interactive) (consult-find "~/.dotfiles/.config/guix/manifests/")) :which-key "manifests")
...
Trying Consult+Vertico as an alternative to Ivy and Counsel.
...
#+begin_src emacs-lisp
  ...
  (defun bw/org-roam-filter-by-tag (tag-name)
    (lambda (node)
      (member tag-name (org-roam-node-tags node))))

  (defun bw/org-roam-list-notes-by-tag (tag-name)
    (mapcar #'org-roam-node-file
            (seq-filter
             (bw/org-roam-filter-by-tag tag-name)
             (org-roam-node-list))))
  ...
  (defun bw/org-roam-refresh-agenda-list ()
    (interactive)
    (setq org-agenda-files (bw/org-roam-list-notes-by-tag "Project")))
  ...
  (setup (:pkg org-roam :straight t)
    ...
    (:when-loaded
      ...
      (bw/org-roam-refresh-agenda-list))
